    ...
    <div className="space-y-6">
      ...
      <div className="bg-muted/30 border border-border rounded-lg p-6">
        <div className="flex items-start gap-3 mb-4">
          ...
          <div>
            <h3 className="font-display text-base font-semibold text-foreground mb-1">Regra padrão aplicável</h3>
            <p className="text-xs text-muted-foreground">O que acontece se não houver customização suficiente</p>
          </div>
        </div>
